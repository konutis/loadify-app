    ...
    render () {
        return (
            <div className='form-container' onSubmit={this.handlePointAdd}>
                <form className='form'>
                    <input required onChange={this.handleInputChange} className='form-input' type='text' id='pointName'
                        placeholder='NAME' name='pointName' value={this.state.pointName} />
                    <input required onChange={this.handleInputChange} className='form-input' type='number' id='latitude'
                        placeholder='LATITUDE' name='lat' value={this.state.lat} />
                    <input required onChange={this.handleInputChange} className='form-input' type='number' id='longitude'
